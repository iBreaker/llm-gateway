...
|----------|------------|------|------|----------|
| Claude 3 Haiku | `claude-3-haiku-20240307` | 旧版 Haiku | ❌ 失败 | Invalid model name |
...
- `claude-3-7-sonnet-latest` - 混合推理模型
...
| 特性 | Opus 4.1 | Sonnet 4 | Sonnet 3.7 | Haiku 3.5 |
|------|----------|----------|------------|-----------|
| **推理能力** | 最强 | 很强 | 强 | 中等 |
| **响应速度** | 慢 | 中等 | 可调节 | 最快 |
| **适用场景** | 复杂任务 | 平衡使用 | 混合推理 | 快速问答 |
| **成本** | 最高 | 高 | 中等 | 最低 |
| **上下文长度** | 很长 | 长 | 长 | 中等 |
